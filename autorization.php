...
<main>
    <div class="mx-auto rounded-xl bg-white bg-opacity-60 flex flex-col w-5/12 mt-32 p-10">
        <h1 class="text-pink-600 font-bold text-xl text-center">Авторизация</h1>
        ...
        <div class="flex flex-row w-8/12 mx-auto justify-between">
            ...
            <button class="bg-white w-2/5 rounded-xl h-10 ease-in duration-300 hover:bg-pink-600 " name="log" type="submit">Войти</button>
            <button class="bg-white w-2/5 rounded-xl h-10 ease-in duration-300 hover:bg-pink-600 " id="reg">Зарегистрироваться</button>
        </div>
    </div>
</main>
...
<script>
    document.getElementById('reg').addEventListener('click', openNewPage);
